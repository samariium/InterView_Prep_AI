        ...
        >
            ...
            <div className="px-3 pb-3">
                <div className="flex items-center gap-3 mt-4">
                    <div className="text-[10px] font-medium text-black px-3 py-1 border-[0.5 px] border-gray-900 rounded-full">
                    ...
                    <div className="text-[10px] font-medium text-black px-3 py-1 border-[0.5x] border-gray-900 rounded-full">
