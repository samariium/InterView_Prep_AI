          ...
          <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0">
            <div className="flex items-center justify-start mb-2">
              <div className="flex items-center gap-2 text-[13px] text-amber-600 font-semibold bg-amber-100 px-3 py-1 rounded-full border border-amber-300">
                <luSparkles/>AI Powered Interview Preparation
              </div>
            </div>

            <h1 className="text-5xl text-black font-medium mb-1 leading-tight">
              Ace Your Interviews with AI-Powered Preparation<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF9324] to-[#FCD760] bg-[length:200%_20%] animate-text-shine font-semibold">
