      ...
      <div className="container mx-auto pt-4 pb-4 px-4 md:px-0">
        ...
        <div className="grid grid-cols-12 gap-4 mt-5 mb-10">
          <div className={`col-span-12 ${openLeanMoreDrawer ? "md:col-span-7" : "md:col-span-8"}`}>
            <div className="space-y-4"> {/* Added wrapper with consistent spacing */}
              <AnimatePresence>
              ...
              {!isLoading && sessionData?.questions?.length > 0 && (
                <div className="flex justify-center mt-6">
                  <button
                    className="flex items-center gap-2 text-sm text-white font-medium bg-black px-4 py-2 rounded hover:bg-gray-800 transition-colors"
